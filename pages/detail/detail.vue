<template>
	<view>
		...
		<view class="mglr4 xqInfor">
			<view class="center pdtb15 fs16">健康知识标题标题标题</view>
			<view class="cont fs13">
				...
				<view>监管科了付赛的价格过节费考虑到加工费来电管家发了个结果翻到鬼斧神工金融机构日就是个交管理费见到过和公司就发了活过来了供货方的记录可挂号费了家里就结果回访供货方健康的两个号</view>
				<view><image class="w" src="../../static/images/details-img.png" mode="widthFix"></image></view>
			</view>
		</view>
